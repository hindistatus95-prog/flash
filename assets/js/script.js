...
var $header_slider = $(".header-slider");
if ($header_slider.length > 0) {
  var slideCount = $header_slider.find(".single-slide").length;
  if (slideCount > 1) {
    $header_slider.owlCarousel({
      items: 1,
      margin: 0,
    ...
    // Only 1 slide, show normally
    $header_slider
      .find(".single-slide")
      .css("display", "block") // make it visible
      .addClass("active"); // add any active classes your CSS/animations need
  }
}
