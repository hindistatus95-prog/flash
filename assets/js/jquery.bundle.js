...
($.cookie = function (e, t, r) {
  ...
  if (r.expires && ("number" == typeof r.expires || r.expires.toUTCString)) {
    ...
    "number" == typeof r.expires
      ? ((u = new Date()),
        u.setTime(u.getTime() + 24 * r.expires * 60 * 60 * 1e3))
      : (u = r.expires),
  ...
  jQuery(function () {
    (themes_panel_width = jQuery("#themes_menu").outerWidth()),
      jQuery("#themes_panel").css("right", 0),
      jQuery("#themes_panel").animate({ right: -themes_panel_width }, 400),
      jQuery("#toggle_button a.toggle-theme-panel").click(function () {
        var e = jQuery(this).parent().parent();
        return (
          e.animate(
            {
              right:
                0 == parseInt(e.css("right"), 10) ? -themes_panel_width : 0,
            },
            400
          ),
          !1
      ...
      jQuery("#themes_panel ul.theme.cookie_layout_style li a").click(
        function () {
          var e = jQuery(this).attr("title");
          return (
            $.cookie("cookie_style", e, { expires: 0, path: "/" }),
            jQuery("#layoutstyle").attr("href", "assets/css/" + e + ".css"),
            !1
          );
        }
      );
